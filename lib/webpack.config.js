...
function getConfiguration(settings) {
    ...
    let config = {
        ...
        resolve: {
            ...
            alias: {
                'Project': settings.path.projectAppDir,
                'Spryker': settings.path.sprykerAppDir
            }
        },
        ...
        plugins: [
            ...
            new webpack.ContextReplacementPlugin(/^Project/, settings.paths.projectAppDir),
            new webpack.ContextReplacementPlugin(/^Spryker/, settings.paths.sprykerAppDir),
            baseCss,
            utilCss,
            css
        ]
